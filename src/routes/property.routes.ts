...
propertyRoutes.get("/user/nearest-prop", PropertyController.getNearestProperties);
propertyRoutes.get("/collocated-prop/:pid", PropertyController.getCollocatedProperties);
